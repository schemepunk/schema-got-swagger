...
class GetDefaults    {
   ...
   */
  constructor(defaultType        , swaggerVersion          = '2.0.0')       {
   ...
   */
  getswaggerSrctemplatesDefaults()             {
   ...
   * @memberof GetDefaults
   */
  getSwaggerTemplateYaml(defaults        )             {
